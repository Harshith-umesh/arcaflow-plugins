...
@dataclass
class KubeBurnerNodeDensityInputParams(KubeBurnerCommonInputParams):
    """
    This is the data structure for the input parameters for kube-burner cluster density workload.
    """
...
@dataclass
class KubeBurnerNodeDensityHeavyInputParams(KubeBurnerCommonInputParams):
    """
    This is the data structure for the input parameters for kube-burner cluster density workload.
    """
...
@dataclass
class KubeBurnerNodeDensityCniInputParams(KubeBurnerCommonInputParams):
    """
    This is the data structure for the input parameters for kube-burner cluster density workload.
    """
