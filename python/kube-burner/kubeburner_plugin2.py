...
from kubeburner_schema2 import KubeBurnerInputParams, KubeBurnerOutput, WorkloadError, kube_burner_input_schema, kube_burner_output_schema
...
def RunKubeBurnerIndexer(params: KubeBurnerInputParams ) -> typing.Tuple[str, typing.Union[KubeBurnerOutput, WorkloadError]]:
...
def RunKubeBurnerPodDensity(params: KubeBurnerInputParams ) -> typing.Tuple[str, typing.Union[KubeBurnerOutput, WorkloadError]]:
...
def RunKubeBurnerClusterDensity(params: KubeBurnerInputParams ) -> typing.Tuple[str, typing.Union[KubeBurnerOutput, WorkloadError]]:
...
def RunKubeBurnerNodeDensity(params: KubeBurnerInputParams ) -> typing.Tuple[str, typing.Union[KubeBurnerOutput, WorkloadError]]:
...
def RunKubeBurnerNodeDensityHeavy(params: KubeBurnerInputParams ) -> typing.Tuple[str, typing.Union[KubeBurnerOutput, WorkloadError]]:
...
def RunKubeBurnerNodeDensityCni(params: KubeBurnerInputParams ) -> typing.Tuple[str, typing.Union[KubeBurnerOutput, WorkloadError]]:
